...
int main (void) {
	...
	while (contador < K) {
		...
		if (X0 <= 0 && X0 < bordaEsquerda + 0.5) {
			
			bordaEsquerda = X0 - 0.5;

   		} else if (X0 >= 0 && X0 > bordaDireita - 0.5) {
			
			bordaDireita = X0 + 0.5;

   		}
		
		if (Y0 <= 0 && Y0 < bordaInferior + 0.5) {

			bordaInferior = Y0 - 0.5;

		} else if (Y0 >= 0 && Y0 > bordaSuperior - 0.5) {
	...
	//Durante o Looping ele ja vai somando os valores da Área das ilhas
	while(!0) {
		...
		if (Xn == X0 && Yn == Y0) {
				...
				if (Xn <= 0 && Xn < bordaEsquerda + 0.5) {
					
					bordaEsquerda = Xn - 0.5;

				} else if (Xn >= 0 && Xn > bordaDireita - 0.5) {

					bordaDireita = Xn + 0.5;
				
				}
			
				if (Yn <= 0 && Yn < bordaInferior + 0.5) {
					
					bordaInferior = Yn - 0.5;
				
				} else if (Yn >= 0 && Yn > bordaSuperior - 0.5) {
	...
	if (bordaSuperior < 0) {
		...
		if (bordaInferior < 0) {
			...
			bordaInferior = -bordaEsquerda;
			eixoX = bordaSuperior - bordaInferior;	
